# [SOLVED] Getting-A-Fatal-Error-In-Git-For-Multiple-Stage-Entries
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/getting-a-fatal-error-in-git-for-multiple-stage-entries)
>
...
Try using `git reset --hard` to discard all changes and start fresh, then re-add your files with `git add .` and commit again.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/getting-a-fatal-error-in-git-for-multiple-stage-entries)**
